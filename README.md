About topika-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/topika-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2086&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/topika-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `topika` can be installed with `conda`:
...
```
mamba install topika
```

It is possible to list all of the versions of `topika` available on your platform with `conda`:
...
```
mamba search topika --channel conda-forge
```
...
mamba repoquery search topika --channel conda-forge

# List packages depending on `topika`:
mamba repoquery whoneeds topika --channel conda-forge

# List dependencies of `topika`:
mamba repoquery depends topika --channel conda-forge
```
